...
using JEH01V_HFT_2021222.Repository;
using JEH01V_HFT_2021222.Repository.Interfaces;
using JEH01V_HFT_2021222.Repository.Repositories;
...
namespace JEH01V_HFT_2021222.Endpoint
{
    public class Startup
    {
        ...
        {
            services.AddTransient<GenshinDbContext>();

            services.AddTransient<IRepository<Character>, CharacterRepository>();
            services.AddTransient<IRepository<Artifact>, ArtifactRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "JEH01V_HFT_2021222.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "JEH01V_HFT_2021222.Endpoint v1"));
            }
